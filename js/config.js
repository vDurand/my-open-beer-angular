module.exports=function($routeProvider,$locationProvider,$httpProvider) {
	...
	when('/', {
		...
		controller: 'BreweryUpdateController'
            ...
            templateUrl: 'templates/breweries/detail.html',
            controller: 'BreweryDisplayController'
    }).when('/saves', {
		...
		controller: 'ConfigController'
            ...
            templateUrl: 'templates/beers/breweryOrder.html',
            controller: 'BeerBreweryController'
    }).when('/login', {
